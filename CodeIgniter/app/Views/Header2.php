...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo base_url ();?>/assets/css/formulariocss.css">
...
<header id="encabezado">
	<nav  class="navbar navbar-default" style="height: 50px;">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Actividades de Especiales</a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li><a href="index.html">Restaurantes</a></li>
            <li class="active"><a href="paginas.html">Conocenos</a></li>
            <li><a href="entradas.html">Compras</a></li>
